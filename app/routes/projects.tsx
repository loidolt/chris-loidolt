...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { name: "description", content: "Browse design and engineering projects in 3D printing, woodworking, and software development." },
    { property: "og:title", content: "Projects - Chris Loidolt" },
    { property: "og:description", content: "Browse design and engineering projects in 3D printing, woodworking, and software development." },
    { name: "twitter:title", content: "Projects - Chris Loidolt" },
    { name: "twitter:description", content: "Browse design and engineering projects in 3D printing, woodworking, and software development." },
  ];
}
